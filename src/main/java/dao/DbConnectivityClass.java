...
public class DbConnectivityClass {
    final static String DB_NAME="csc311nikiforov18";
        MyLogger lg= new MyLogger();
        final static String SQL_SERVER_URL = "jdbc:mysql://csc311nikiforov18.mysql.database.azure.com/";//update this server name
        final static String DB_URL = SQL_SERVER_URL + DB_NAME;//update this database name
        final static String USERNAME = "nikim";// update this username
        final static String PASSWORD = "CSC311password";// update this password
